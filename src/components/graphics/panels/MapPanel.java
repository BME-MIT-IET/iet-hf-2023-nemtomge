...
public class MapPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g){
        ...
        g2d.drawImage(map,0,0,1333,1057,null);
            ...
            for(ScientistWrapper scWrapper : scientistWrappers) {
                for(int i = 0;i<scientists.size();i++) {
                    if(scWrapper.getScientist().equals(scientists.get(i))) {
                        if(i == 0) {
                            g2d.drawImage(scWrapper.getTexture(), (int)(fw.getP1().x * (1333/1536.0)), (int)(fw.getP1().y * (1057/1080.0)), 128/2, 128/2, null);
                        } else {
                            g2d.drawImage(scWrapper.getTexture(), (int)(fw.getP2().x * (1333/1536.0)), (int)(fw.getP2().y * (1057/1080.0)), 128/2, 128/2, null);
                        }
                    }
                }
            }
